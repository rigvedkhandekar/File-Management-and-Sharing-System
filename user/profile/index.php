            ...
            <div class="mt-4 row clearfix">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fname" name="fname" value="<?php echo $data['fn']; ?>" readonly="true">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="lname" name="lname" value="<?php echo $data['ln']; ?>" readonly="true">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="contact" name="contact" value="<?php echo $data['contact']; ?>" readonly="true">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="profession" name="profession" value="<?php echo $data['profession']; ?>" readonly="true">
