                        ...
                        <div class="card-body">
                            <div class="dt-responsive">
                                <table id="simpletable" class="table table-striped table-bordered nowrap table-responsive">
                                    ...
                                    $query = "SELECT * from `mails` where `receiver` = :receiver";
                                    $result = query($query,['receiver'=>$receiver]);
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button" name="" class="btn btn-warning"><?php echo $data['sender']; ?></button></td>
